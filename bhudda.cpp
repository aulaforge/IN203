...
//  Je n'arrive pas à paralléliser ce calcul, avec ce que j'ai fait, je trouve un temps de calcul plus élevé que pour un calcul normal (memory bound?)
...
#pragma omp parallel shared(image, nbSamples)
